...
/**
 * Version of upstream {@link org.keycloak.testframework.oauth.nimbus.OAuthClient} that can deal with already existing
 * Keycloak clients, e.g., living inside a running Keycloak Testcontainer with an imported Keycloak configuration file,
 * instead of with {@link org.keycloak.testframework.realm.ClientConfig}s for new Keycloak clients.
 */
public class OAuthClientForKeycloakTestcontainersClient {
    ...
    /**
     * Retrieve {@link ManagedClient} for existing Keycloak client in the given managed realm.
     */
    ...
    /**
     * Don't delete the client, just close the {@link OAuthCallbackServer}.
     */
    public void close() {
